...
<div class="container-fluid">
    <p>Warning, translations are not visible until they are exported back to the app/lang file, using <code>php artisan
            translation:publish</code> command or publish button.</p>
    ...
    <?php if ($group): ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <ul class="list-unstyled list-inline">
                    <?php
                    foreach ($static as $locale => $item) {
                        ?>
                        <li><strong style="text-transform: uppercase"><?php echo $locale ?></strong>:
                            <strong title="đã dịch" class="text-success"><?php echo $item['empty'] ?></strong>/<strong title="tổng số"><?php echo $item['total'] ?></strong>
                        </li>
                        <?php
                    }
                    ?>
        ...
        <table class="table">
            ...
            <?php foreach ($translations as $key => $translation): ?>
                <tr id="<?php echo htmlentities($key, ENT_QUOTES, 'UTF-8', false) ?>" class="<?php echo $translation['en']->no_use == 1 ? 'no-use' : '' ?>">
